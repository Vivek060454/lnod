...
class HtmlWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    /// Here you can change code the tab is not wworking from here
    /// it may also possble it it not recognising mouse event so once you change here in whole
    /// application it will work
    /// So can I close anydesk now ?how can we change? For that you have to do R&D
    /// we will try to fix in our side as  osoon as possib;e
    //;ok once you done pls let me know ok -) wait one issue
    ...
    return Html(
      ...
      style: {
        ...
        'strong': Style(color: color ?? textPrimaryColorGlobal,textAlign: TextAlign.left, fontSize: FontSize(fontSize), lineHeight: LineHeight(ARTICLE_LINE_HEIGHT), padding: HtmlPaddings.zero),
        'a': Style(
