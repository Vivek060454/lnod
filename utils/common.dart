...
InputDecoration inputDecoration(
  ...
  return InputDecoration(
    ...
    enabledBorder: UnderlineInputBorder(borderSide: BorderSide(color: dividerColor, width: 1.0)),
...
InputDecoration inputDecorationFilled(
  ...
  return InputDecoration(
    ...
    hintText: hint ?? null,
    hintStyle: secondaryTextStyle(weight: FontWeight.w600),
...
String parseHtmlString(String? htmlString) {
  return parse(parse(htmlString).body!.text).documentElement!.text.replaceAll("&amp;", "");
}
