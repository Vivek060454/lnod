...
class RegisterHereWeb extends StatefulWidget {
  const RegisterHereWeb({Key? key}) : super(key: key);

  @override
  State<RegisterHereWeb> createState() => _RegisterHereWebState();
}

class _RegisterHereWebState extends State<RegisterHereWeb> {
