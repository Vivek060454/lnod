...
class LNODCommunitiesOF extends StatefulWidget {
  const LNODCommunitiesOF({Key? key}) : super(key: key);

  @override
  State<LNODCommunitiesOF> createState() => _LNODCommunitiesOFState();
}

class _LNODCommunitiesOFState extends State<LNODCommunitiesOF> {
  ...
  void initState() {
    ...
    controller = WebViewController()
      ...
      ..loadRequest(
        Uri.parse(Url().lnodCommunititesOf),
      );
  }
  @override
