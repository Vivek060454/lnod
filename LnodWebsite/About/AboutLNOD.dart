...
class AboutLNOD extends StatefulWidget {
  const AboutLNOD({Key? key}) : super(key: key);

  @override
  State<AboutLNOD> createState() => _AboutLNODState();
}

class _AboutLNODState extends State<AboutLNOD> {
  ...
  void initState() {
    ...
    controller = WebViewController()
      ...
      ..loadRequest(
        Uri.parse(Url().aboutLNOD),

          headers : {

           "Authorization": "Bearer ${ appStore.token.toString()}"
            // "Cookie":"auth=${appStore.token.toString()}",
