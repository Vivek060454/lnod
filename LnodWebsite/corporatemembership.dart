...
class Corporatemembership extends StatefulWidget {
  const Corporatemembership({Key? key}) : super(key: key);

  @override
  State<Corporatemembership> createState() => _CorporatemembershipState();
}

class _CorporatemembershipState extends State<Corporatemembership> {
  ...
  void initState() {
    ...
    controller = WebViewController()
      ...
      ..loadRequest(
      Uri.parse(Url().corporatemembership,),
