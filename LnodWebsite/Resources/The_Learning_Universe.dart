...
class TheLearningUniverse extends StatefulWidget {
  const TheLearningUniverse({Key? key}) : super(key: key);

  @override
  State<TheLearningUniverse> createState() => _TheLearningUniverseState();
}

class _TheLearningUniverseState extends State<TheLearningUniverse> {
 ...
 late final WebViewController controller;
  ...
  void initState() {
    ...
    controller = WebViewController()
      ...
      ..loadRequest(
        Uri.parse(Url().TheLearningUniverse),
