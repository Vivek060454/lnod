...
class LearningResorce extends StatefulWidget {
  const LearningResorce({Key? key}) : super(key: key);

  @override
  State<LearningResorce> createState() => _LearningResorceState();
}

class _LearningResorceState extends State<LearningResorce> {
  ...
  void initState() {
    ...
    controller = WebViewController()
      ...
      ..loadRequest(
        Uri.parse(Url().learningresource),
          headers : {
