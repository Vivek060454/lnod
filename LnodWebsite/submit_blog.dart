...
class SubmitBlog extends StatefulWidget {
  const SubmitBlog({Key? key}) : super(key: key);

  @override
  State<SubmitBlog> createState() => _SubmitBlogState();
}

class _SubmitBlogState extends State<SubmitBlog> {
