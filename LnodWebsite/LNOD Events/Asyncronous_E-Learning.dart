...
class AsyncronousELearning extends StatefulWidget {
  const AsyncronousELearning({Key? key}) : super(key: key);

  @override
  State<AsyncronousELearning> createState() => _AsyncronousELearningState();
}

class _AsyncronousELearningState extends State<AsyncronousELearning> {
  ...
  void initState() {
    ...
    controller = WebViewController()
      ...
      ..loadRequest(
        Uri.parse(Url().asyncronousELearning),
