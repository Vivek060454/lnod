...
class LNODAcademy extends StatefulWidget {
  const LNODAcademy({Key? key}) : super(key: key);

  @override
  State<LNODAcademy> createState() => _LNODAcademyState();
}

class _LNODAcademyState extends State<LNODAcademy> {
